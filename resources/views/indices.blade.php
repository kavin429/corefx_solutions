...
<div class="page-card">
  ...
  <section class="hero">
    <video autoplay muted loop playsinline class="hero-video">
      <source src="{{ asset('pics/indices.mp4') }}" type="video/mp4">
    </video>
  ...
  <section class="product-description fade-section">
    <div class="container">
      <h2>INDICES</h2>
      <p>
       More than 20 Major Indices. Infinity Trade Solutions LTD provides exposure 
...
<footer class="footer">
  ...
  <div class="footer-legal">
    ...
    <p>Past performance is not indicative of future results. The information on our website is provided for 
      ...
      Yemen, and Zimbabwe. Infinity Trade Solutions LTD may reject any applicant from any jurisdiction 
      at their sole discretion without the requirement to explain the reason why (Terms and conditions).</p>
  </div>
